...
let longIslandIcedTea = CocktailData(id: "longIslandIcedTea", name: "Long Island Iced Tea", alcohol: 0.20, ingredients: [IQ(gin, 2), IQ(tequila, 2), IQ(vodka, 2), IQ(rumLight, 2), IQ(liqueurOrange, 2), IQ(syrupSimple, 4), IQ(lemon, 3), IQ(sodaCola, 2, .dashes)], ice: .cube, glass: .collins, equipment: [.barspoon], wikipedia: "Long_Island_iced_tea", related: [])
...
let whiskeySour = CocktailData(id: "whiskeySour", name: "Whiskey Sour", alcohol: 0.15, ingredients: [IQ(whiskeyBourbon, 6), IQ(lemon, 4), IQ(syrupSimple, 2)], ice: .cube, glass: .wine, equipment: [.shaker, .strainer], wikipedia: "Screwdriver_(cocktail)", related: [])
